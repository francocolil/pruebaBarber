...
function Footer() {
  return (
    // <!-- Footer -->
    <footer class="bg-neutral-100 text-center text-neutral-600 dark:bg-black dark:text-neutral-200 mt-10">
      {/* <!-- REDES SOCIALES --> */}
          ...
          <div class="mb-6">
            ...
            <ul class="mb-0 list-none">
              <li>
                <a
                  href="#!"
                  class="text-neutral-600 hover:text-neutral-800 dark:text-neutral-200"
                >
                  Lost Worlds
                </a>
              </li>
